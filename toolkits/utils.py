...
'''
:method definition: generate training tag
------------------------
:param      net_class       model class 
:param      face_policy     face process strategy 
:param      patch_size      cuttings size
:param      traindb         trainingset parameter 
:param      seed            random seed         
:param      debug           
:param      note            comment for this training 
'''
...
'''
:method definition: generate transformer for data loading
-------------------
:param  patch_size      cuttings size
:param  net_normalizer  
:param  train           training flag 
-------------------
:return transf          generated transformer 
