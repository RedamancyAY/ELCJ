...
:method definition 
-------------------------------
:param record   pics corresponding dataframe 
:param root     the folder of pics
:param size     cuttings size 
:param scale    pic process approach 
:param transformer  transformer instance 
-------------------------------
:return face[ndarray] processed face
'''
...
class FrameFaceIterableDataset(IterableDataset):
    ...
    '''
    :method definition Get the pic according to dataframe index   
    ---------------------------------------------------
    :param item[pd.index] dataframe index
    ---------------------------------------------------
    :return face[ndarray] face (ndarray) 
    :return label[int] face label 
    '''
